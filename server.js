...
const corsOptions = {
  origin: 'http://localhost:8080', // הגדרת המקור המדויק שמותר לו לגשת
  credentials: true,                // אישור שליחת credentials (כמו cookies)
  optionsSuccessStatus: 200         // נדרש לדפדפנים ישנים מסוימים
};
